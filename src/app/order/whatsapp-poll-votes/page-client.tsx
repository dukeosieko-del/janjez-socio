...
const WHATSAPP_POLL_VOTES_CATEGORY = "whatsapp-poll-votes";

export default function WhatsAppPollVotesClient() {
  ...
  const pollVotesServices = useMemo(() => getServicesByCategory(WHATSAPP_POLL_VOTES_CATEGORY), []);
  ...
  }, [selectedService, link, quantityNum, quantityError, total, walletBalance, user, openAuth, targetOption]);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="mb-10">
              ...
              <p className="text-kenya-white/60 text-lg max-w-2xl">
                Boost your WhatsApp polls with instant, real votes. Choose from standard instant delivery, targeted option selection, premium Kenyan verified, or enterprise turbo packages.
              </p>
            </div>

            {/* Quick Order Cards */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              {pollVotesServices.map((service) => (
                <Link
                  key={service.id}
                  href={`/order/whatsapp-poll-votes/${service.id}`}
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 mb-6">
              <label className="block text-sm font-semibold text-kenya-white/70 mb-3 uppercase tracking-wider">
                Select WhatsApp Poll Votes Service
              </label>
              <select
              ...
              <div className="bg-kenya-green/10 border border-kenya-green/30 rounded-2xl p-6 mb-6">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  <span className="inline-flex items-center gap-1.5 bg-kenya-black/60 text-kenya-white text-xs px-3 py-1.5 rounded-lg border border-kenya-white/10">
                    ⚡ Rate: KES {selectedService.rate.toFixed(2)} / vote
                  </span>
              ...
              <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 mb-6">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-kenya-white/40 text-xs mt-2">Supports chat.whatsapp.com group links</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter target option number or text (e.g., Option 1, Yes, etc.)"
                      className="w-full bg-kenya-black border border-kenya-white/20 rounded-xl px-4 py-3 text-kenya-white placeholder-kenya-white/30 focus:outline-none focus:border-kenya-green focus:ring-1 focus:ring-kenya-green transition-all"
                    />
                    <p className="text-kenya-white/40 text-xs mt-2">Specify which poll option to vote for</p>
                  </div>
