        ...
        <main className="flex-1">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <nav className="flex items-center gap-2 text-sm text-kenya-white/50 mb-6">
              ...
              <span>/</span>
              <Link href="/order/whatsapp-channel-post-reactions-cheap-slow-server" className="hover:text-kenya-green transition-colors">WhatsApp Channel Post Reactions [Cheap / Slow Server]</Link>
              <span>/</span>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-kenya-black/40 rounded-xl p-4 border border-kenya-green/30">
                  ...
                  <p className="text-kenya-green font-bold text-lg">KES {(calculatePrice(service.rate, 1)).toFixed(4)}</p>
                </div>
              </div>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  />
                  <p className="text-kenya-white/40 text-xs mt-2">Ensure the target WhatsApp channel post link is public and active before submitting your order</p>
                </div>
