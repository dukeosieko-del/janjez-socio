...
export default function FulfillmentClient({ serviceId }: FulfillmentClientProps) {
  ...
  const savings = useMemo(() => subtotal - total, [subtotal, total]);
  ...
  const handlePlaceOrder = useCallback(() => {
    ...
    openAuth("login");
  }, [service, link, quantityNum, quantityError, linkError, total, walletBalance, isAnonymous]);
        ...
        <main className="flex-1">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <nav className="flex items-center gap-2 text-sm text-kenya-white/50 mb-6">
              ...
              <span>/</span>
              <Link href="/order/x" className="hover:text-kenya-green transition-colors">X (Twitter) Services</Link>
              <span>/</span>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-kenya-black/40 rounded-xl p-4 border border-kenya-white/5">
                  ...
                  <p className="text-kenya-white font-bold text-sm">KES {service.rate.toFixed(2)}</p>
                </div>
                <div className="bg-kenya-black/40 rounded-xl p-4 border border-kenya-green/30">
                  ...
                  <p className="text-kenya-green font-bold text-lg">KES {(service.rate * HAPPY_HOUR_DISCOUNT).toFixed(2)}</p>
                </div>
              </div>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-kenya-white/40 text-xs mt-2">Supports both x.com and twitter.com links</p>
                </div>
                ...
                <div>
                  ...
                  {!quantityError && quantityNum > 0 && <p className="text-kenya-green text-sm mt-2">✓ Valid quantity</p>}
                </div>
                ...
                {total > walletBalance && total > 0 && (
                  <div className="bg-kenya-red/10 border border-kenya-red/30 rounded-xl p-4 flex items-center gap-3">
                    ...
                    <p className="text-kenya-white/80 text-sm">Insufficient wallet balance (KES {walletBalance.toLocaleString()}). Click &quot;Place Order&quot; to top up via M-Pesa.</p>
                  </div>
                )}
