          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="mb-10">
              ...
              <p className="text-kenya-white/60 text-lg max-w-2xl">
                High-quality profile auto reactions for WhatsApp channel future posts. HQ profiles with natural engagement on up to 500 future posts.
              </p>
            </div>
              ...
              {reactionsServices.map((service) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-kenya-green font-bold text-sm">KES {calculatePrice(service.rate, 1).toFixed(2)}</span>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 mb-6">
              <label className="block text-sm font-semibold text-kenya-white/70 mb-3 uppercase tracking-wider">
                Select WhatsApp Channel Auto Future Post Reactions Service
              </label>
              <select
              ...
              <div className="bg-kenya-green/10 border border-kenya-green/30 rounded-2xl p-6 mb-6">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <span className="inline-flex items-center gap-1.5 bg-kenya-red/20 text-kenya-red text-xs px-3 py-1.5 rounded-lg border border-kenya-red/30">
                    🔥 Happy Hour: KES {calculatePrice(selectedService.rate, 1).toFixed(2)}
                  </span>
