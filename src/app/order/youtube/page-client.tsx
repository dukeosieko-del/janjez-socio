          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="mb-10">
              ...
              <p className="text-kenya-white/60 text-lg max-w-2xl">
                Boost your YouTube channel with views, subscribers, likes, and comments.
                High-retention, monetization-safe services with instant delivery.
              </p>
            </div>
            ...
            {selectedService && (
              <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 mb-6">
                ...
                <div className="space-y-5">
                  ...
                  {/* Comments (conditional - only for YouTube Comments) */}
                  {selectedService.requiresComments && (
                    <div>
                      <label className="block text-sm font-medium text-kenya-white/70 mb-2">
                        💬 Custom Comments / Text <span className="text-kenya-white/40">(one per line)</span>
                      </label>
                      <textarea
                        required
                        value={comments}
