        ...
        <main className="flex-1">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <nav className="flex items-center gap-2 text-sm text-kenya-white/50 mb-6">
              ...
              <span>/</span>
              <Link href="/order/youtube-likes" className="hover:text-kenya-green transition-colors">YouTube Likes</Link>
              <span>/</span>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-kenya-black/40 rounded-xl p-4 border border-kenya-white/5">
                  ...
                  <p className="text-kenya-white font-bold text-sm">KES {service.rate.toFixed(2)} / like</p>
                </div>
                <div className="bg-kenya-black/40 rounded-xl p-4 border border-kenya-green/30">
                  ...
                  <p className="text-kenya-green font-bold text-lg">KES {(service.rate * HAPPY_HOUR_DISCOUNT).toFixed(2)} / like</p>
                </div>
              </div>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  />
                  <p className="text-kenya-white/40 text-xs mt-2">Supports youtube.com/watch, youtu.be, and youtube.com/shorts links</p>
                </div>
                ...
                {quantityNum > 0 && !quantityError && (
                  <div className="bg-kenya-black/60 rounded-xl p-5 border border-kenya-white/10 space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-kenya-white font-medium">{quantityNum.toLocaleString()} likes</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
