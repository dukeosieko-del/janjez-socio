        ...
        <main className="flex-1">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <nav className="flex items-center gap-2 text-sm text-kenya-white/50 mb-6">
              ...
              <span>/</span>
              <Link href="/order/whatsapp-channel-followers" className="hover:text-kenya-green transition-colors">WhatsApp Channel Followers</Link>
              <span>/</span>
            ...
            <div className="bg-kenya-white/5 border border-kenya-white/10 rounded-2xl p-6 sm:p-8 mb-6">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  />
                  <p className="text-kenya-white/40 text-xs mt-2">Supports whatsapp.com/channel links</p>
                </div>
