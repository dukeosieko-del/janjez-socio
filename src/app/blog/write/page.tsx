...
export default function BlogWritePage() {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      router.push(`/blog/${data.post.slug}/edit`);
    } catch {
        ...
        <main className="flex-1">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <nav className="flex items-center gap-2 text-sm text-kenya-white/50 mb-6">
              ...
              <span>/</span>
              <span className="text-kenya-green font-medium">Write Article</span>
            </nav>

            <div className="mb-8">
              <h1 className="text-3xl sm:text-4xl font-bold text-kenya-white mb-2">Write a New Article</h1>
              <p className="text-kenya-white/60">Share your SMM knowledge with the janjez.social community.</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-kenya-white/5 border border-kenya-white/20 rounded-xl overflow-hidden">
                  <div className="flex items-center gap-1 p-2 border-b border-kenya-white/10">
                    ...
                    <div className="w-px h-4 bg-kenya-white/10 mx-1"></div>
                    <button type="button" onClick={() => { const url = prompt('Enter URL:'); if (url) document.execCommand('createLink', false, url); }} className="p-1.5 text-kenya-white/60 hover:text-kenya-white hover:bg-kenya-white/10 rounded">
                      🔗
                    </button>
                  </div>
                  <div
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="https://example.com/image.jpg or /blog/my-cover.jpg"
                  className="w-full bg-kenya-white/5 border border-kenya-white/20 rounded-xl px-4 py-3 text-kenya-white placeholder-kenya-white/30 focus:outline-none focus:border-kenya-green focus:ring-1 focus:ring-kenya-green transition-all"
                />
              </div>
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <Link href="/blog" className="px-6 py-3 text-kenya-white/60 hover:text-kenya-white transition-colors">
                  Cancel
                </Link>
              </div>
            </div>
